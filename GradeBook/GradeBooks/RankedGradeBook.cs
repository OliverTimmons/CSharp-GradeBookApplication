...
namespace GradeBook.GradeBooks
{
    public class RankedGradeBook : BaseGradeBook
    {
        ...
        {
            if (Students.Count < 5)
                throw new InvalidOperationException("Ranked grading requires a minimun of 5 students");
        ...
        {
            if (Students.Count < 5)
                throw new InvalidOperationException("Ranked grading requires at least 5 students with grades in order to properly calcualte a student's overall grade.");
